...
class UserCreate(schemas.BaseUserCreate):
    ...
    company_name: Annotated[str | None, StringConstraints(min_length=2, max_length=100)] = None
    phone_number: Annotated[str | None, StringConstraints(min_length=10, max_length=20)] = None
...
class UserUpdate(schemas.BaseUserUpdate):
    ...
    """
    full_name: Annotated[str, StringConstraints(min_length=2, max_length=100)] | None = None
    company_name: Annotated[str | None, StringConstraints(min_length=2, max_length=100)] = None
    phone_number: Annotated[str | None, StringConstraints(min_length=10, max_length=20)] = None
